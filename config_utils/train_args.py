...
def obtain_train_args():
    ...
    parser.add_argument('--lq_full_path', type=str, default='./data/lq')
    parser.add_argument('--hq_path', type=str, default='./data/gt')
    parser.add_argument('--parse_path', type=str, default='./data/priors/parse')
    parser.add_argument('--heat_path', type=str, default='./data/priors/heat')
    parser.add_argument('--dict_path', type=str, default='./data/priors/dict')
